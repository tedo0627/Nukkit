...
public class Palette {
     ...
     */
    public Palette(int size, boolean read) {
        int numberOfBits = fastFloor(MathHelper.log2(size) - 1) + 1;
        int version = fastFloor(32f / numberOfBits);
    ...
    public byte getPaletteWord() {
        return (byte) ((byte) (this.version.getId() << 1) | 1);
    }
    ...
    public short[] getIndexes() {
        ...
        if (this.output == null) {
            ...
            int iterations = fastCeil(4096 / (float) this.version.getWordsAmount());
